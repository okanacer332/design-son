...
interface CTAProps {
  mode: 'design' | 'code'; // BURASI DUZELTILDI: 'tasarla' -> 'design'
}
        ...
        <div className={`p-8 sm:p-12 md:p-16 rounded-2xl sm:rounded-3xl backdrop-blur-sm border ${
          ...
          <div className="text-center">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-300 mb-8 sm:mb-10 max-w-2xl mx-auto px-4">
              {mode === 'design' 
                ? 'Let\'s work together to create exceptional designs that transform your digital presence and drive real results.'
                : 'Partner with an experienced developer to build enterprise-grade software that scales with your business.'}
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-6 md:gap-8 mt-12 sm:mt-16 pt-12 sm:pt-16 border-t border-white/10">
              <div>
                ...
                <p className="text-xs sm:text-sm md:text-base text-gray-400">
                  {mode === 'design' ? 'Projects Completed' : 'Systems Built'}
                </p>
              </div>
              <div>
                <p className={`text-2xl sm:text-3xl md:text-4xl mb-1 sm:mb-2 ${
                ...
                <p className="text-xs sm:text-sm md:text-base text-gray-400">Client Success Rate</p>
              </div>
              <div>
                <p className={`text-2xl sm:text-3xl md:text-4xl mb-1 sm:mb-2 ${
                  mode === 'design' ? 'text-purple-300' : 'text-blue-300'
                ...
                <p className="text-xs sm:text-sm md:text-base text-gray-400">
                  {mode === 'design' ? 'Available Support' : 'Development Support'}
                </p>
              </div>
            </div>
          </div>
